    var TRX_ADDONS_STORAGE = {
        ...
        , "site_url": "http:\/\/Girlss-html.themerex.net"
        , "vc_edit_mode": "0"
        ...
        var setREVStartSize = function() {
            try {
                ...
                if (e.responsiveLevels && (jQuery.each(e.responsiveLevels, function(e, f) {
                    ...
                    var u = (e.c.width(), Girlss_win.height());
                    if (void 0 != e.fullScreenOffsetContainer) {
                        var c = e.fullScreenOffsetContainer.split(",");
                        if (c) jQuery.each(c, function(e, i) {
                            u = jQuery(i).length > 0 ? u - jQuery(i).outerHeight(!0) : u
                        }), e.fullScreenOffset.split("%").length > 1 && void 0 != e.fullScreenOffset && e.fullScreenOffset.length > 0 ? u -= Girlss_win.height() * parseInt(e.fullScreenOffset, 0) / 100 : void 0 != e.fullScreenOffset && e.fullScreenOffset.length > 0 && (u -= parseInt(e.fullScreenOffset, 0))
                    }
                    f = u
...
function esg_init() {
    if (jQuery("#esg-grid-1-1").length > 0) {
        ...
        if ("even"=="even") {
            ...
            var	cwidth = container.width(),
                ar = "4:4",
                gbfc = eggbfc(Girlss_win.width(),"id"),
                row = 2;
            ar = ar.split(":");
    ...
    var woocs_current_currency = {"name":"USD","rate":1,"symbol":"&#36;","position":"right","is_etalon":1,"hide_cents":0,"decimals":2,"description":"USA dollar","flag":"http:\/\/Girlss-html.themerex.net\/wp-content\/plugins\/woocommerce-currency-switcher\/img\/no_flag.png"};
    var woocs_default_currency = {"name":"USD","rate":1,"symbol":"&#36;","position":"right","is_etalon":1,"hide_cents":0,"decimals":2,"description":"USA dollar","flag":"http:\/\/Girlss-html.themerex.net\/wp-content\/plugins\/woocommerce-currency-switcher\/img\/no_flag.png"};
...
function initShortcodes(container) {
    ...
    if (container.find('.sc_skills_item:not(.inited)').length > 0) {
        ...
        Girlss_win.scroll(function () { sc_init_skills(container); });
    }
}
